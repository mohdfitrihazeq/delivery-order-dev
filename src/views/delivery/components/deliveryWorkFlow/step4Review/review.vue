                ...
                <template #content>
                    <div class="grid gap-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span> {{ deliveryInfo?.driverPlate }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="font-medium">Date:</span>
                            <span>{{ deliveryInfo?.deliveryDate }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <template #content>
                    <div class="grid gap-2 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            <Badge severity="secondary" class="text-gray-800"> 0</Badge>
                        </div>
                        <div class="flex justify-between">
            ...
            <div class="col-12">
                <Card class="border">
                    <template #content>
                        ...
                        <p class="text-center">No items have been marked as delivered</p>
                    </template>
                </Card>
            </div>
        </div>
