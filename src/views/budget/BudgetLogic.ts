...
export function useBudget() {
    ...
    const budgetItems = ref([
        ...
        { itemCode: 'LAB-002', description: 'Site landscaping and soil preparation', location: 'Site Area', element: 'Earthworks', subElement: 'Landscaping', subsubElement: 'Soil Preparation', uom: 'm²', quantity: 850, rate: 25.0, amount: 21250 },
